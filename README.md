...
```
cd existing_repo
git remote add origin https://gitlab.origyn.ch/origyn/engineering/kyc.mo.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.origyn.ch/origyn/engineering/kyc.mo/-/settings/integrations)
